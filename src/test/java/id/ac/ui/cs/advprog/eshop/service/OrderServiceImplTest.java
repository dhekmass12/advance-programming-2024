...
class OrderServiceImplTest {
    ...
    void testUpdateStatusInvalidOrderId(){
        doReturn(null).when(orderRepository).findById("GOD PLEASE HELP ME");

        assertThrows(NoSuchElementException.class,
                () -> orderService.updateStatus("GOD PLEASE HELP ME", OrderStatus.SUCCESS.getValue()));
    ...
    void testFindByIdIfIdNotFound(){
        doReturn(null).when(orderRepository).findById("GOD PLEASE HELP MY MENTAL ISSUE");
        assertNull(orderService.findById("GOD PLEASE HELP MY MENTAL ISSUE"));
    }
